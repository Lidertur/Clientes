            ...
            <div class="container mt-5">
                <div  class="bg-white rounded-lg shadow-lg p-3">
                    ...
                    <div class="container mt-5">
                        ...
                        <a class="btn btn-success mb-4 float-end" href= "?c=usuarioC&a=Formcrear">Agregar</a>
                            ...
                            <table id="usuario" class="table table-striped table-bordered nowrap" style="width:100%">
                                ...
                                <tbody>
                                        ...
                                        <?php foreach ($this->Registro->listar() as $Registro): ?>
                                            <tr>
                                                <td>
                                                    <a href="?c=usuarioC&a=Formcrear&id_U=<?= $usuario['id_U']; ?>" class="btn btn-warning btn-sm" title="Editar">✏️</a>
                                                </td>
                                                <td><?=$registro['id_U'] ?></td>
