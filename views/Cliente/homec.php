    ...
    <body class="bg-light">
        ...
        <div class="sidebar collapse d-lg-block" id="sidebarMenu">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="btn btn-success nav-link text-black mb-5 " href="?c=login&a=logout">🏡 Cerrar Sesión</a>
                </li>
                <li class="nav-item">
            ...
            <div class="container d-flex flex-column align-items-center justify-content-center min-vh-100" >
                <div class="card mx-auto mb-3" style="max-width: 400px; box-shadow: 0 0 55px 1px #000000;">
                    ...
                    <div class="card-body text-center">
                        <h1 class="card-title text-success mb-4">Bienvenido Cliente</h1>
                        <a class="btn btn-success btn-lg w-100 mb-3" href="?c=registros">Inventario de Registros</a>
                        <a class="btn btn-success btn-lg w-100" href="?c=pasajeros">Inventario Pasajeros</a>
                    </div>
                </div>
            </div>
        </div>
